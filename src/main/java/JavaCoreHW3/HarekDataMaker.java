...
public class HarekDataMaker {
    ...
    public String[] aggregateAll (String[] names, int[] ages, String[] planets) {
        ...
        String firstClient = aggregateSingle(names[0], String.valueOf(ages[0]), planets[0]);
        String secondClient = aggregateSingle(names[1], String.valueOf(ages[1]), planets[1]);
        String thirdClient = aggregateSingle(names[2], String.valueOf(ages[2]), planets[2]);

        return new String[] {firstClient, secondClient, thirdClient};
    }
